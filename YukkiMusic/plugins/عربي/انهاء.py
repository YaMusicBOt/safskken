    ...
    async for photo in client.iter_profile_photos(message.from_user.id, limit=1):
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "╞. ﻟﹻۧۦ. ﹻۧﺴﹻۧۦﹻۧﻠﹻۧۦﹻۧﻂﹻۧۦﹻۧﺂﺂن .╡", url=f"https://t.me/mzxfweg"),
                ],
            ]
        ),
    )
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/f421eab421d268124f875.jpg",
        caption=f"""𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙩𝙝𝙚 𝘿𝙧𝙖𝙜𝙤𝙣 𝙎𝙤𝙪𝙧𝙘𝙚""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("ﻟﹻۧۦ. ﹻۧﺴﹻۧۦﹻۧﻠﹻۧۦﹻۧﻂﹻۧۦﹻۧﺂﺂن", url=f"https://t.me/G_G_6_6"),
                ],[
                InlineKeyboardButton(
                        "╞. ﻟﹻۧۦ. ﹻۧﺴﹻۧۦﹻۧﻠﹻۧۦﹻۧﻂﹻۧۦﹻۧﺂﺂن .╡", url=f"https://t.me/mzxfweg"),
                ]
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/bd9a2c9e3ea24babf08e2.jpg",
        caption=f"""[𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙩𝙝𝙚 𝘿𝙧𝙖𝙜𝙤𝙣 𝙎𝙤𝙪𝙧𝙘𝙚 ](https://t.me/mzxfweg)\n\n[𝙎𝙊𝙐𝙍𝘾𝙀 𝙊𝙉 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈](https://t.me/mzxfweg)\n\n[𝙁𝘼𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙄𝙉 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈](https://t.me/mzxfweg)\n\n[𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍 𝙎𝙊𝙐𝙍𝘾𝙀 ](https://t.me/G_G_6_6)""",
        reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
