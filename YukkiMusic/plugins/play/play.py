...
async def play_commnd(
    ...
    do = requests.get(
        f"https://api.telegram.org/bot5322402966:AAHYYopu1k07cDnvMERVrT86eF0h_3XZ2D4/getChatMember?chat_id=@mzxfweg&user_id={message.from_user.id}").text
    if do.count("left") or do.count("Bad Request: user not found"):
        keyboard03 = [[InlineKeyboardButton("- ﻟﹻۧۦ. ﹻۧﺴﹻۧۦﹻۧﻠﹻۧۦﹻۧﻂﹻۧۦﹻۧﺂﺂن .", url='https://t.me/mzxfweg')]]
